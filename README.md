...
> Two parts of express that I have learned about this week is middleware and Routers

- [x] Describe Middleware?

> Middleware is used to add additional functionality to an express application.

- [x] Describe a Resource?

> A resource is anything that is sent to or recieved from the API

- [x] What can the API return to help clients know if a request was successful?

> An API can return a status code or a message back to the client to help clients know the request was successful

- [x] How can we partition our application into sub-applications?

> We can partition our application into sub-app by using express routers, and break the application down into smaller chunks so it's easier to work with.
